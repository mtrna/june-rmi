...
import org.juneframework.remoting.rmi.CodebaseAwareObjectInputStream;
...
public class HttpInvokerClientInterceptor extends RemoteInvocationBasedAccessor
	...
	public Object invoke(MethodInvocation methodInvocation) throws Throwable {
		...
		org.juneframework.remoting.support.RemoteInvocation invocation = createRemoteInvocation(methodInvocation);
		...
		try {
			...
			org.juneframework.remoting.RemoteAccessException rae = convertHttpInvokerAccessException(ex);
	 ...
	 * <p>This implementation delegates to {@link #executeRequest(org.juneframework.remoting.support.RemoteInvocation)}.
	...
	protected RemoteInvocationResult executeRequest(
            org.juneframework.remoting.support.RemoteInvocation invocation, MethodInvocation originalInvocation) throws Exception {
	 ...
	 * Spring {@link org.juneframework.remoting.RemoteAccessException}.
	 * @param ex the exception to convert
	 * @return the RemoteAccessException to throw, or {@code null} to have the
	 * original exception propagated to the caller
	 */
	@Nullable
	protected org.juneframework.remoting.RemoteAccessException convertHttpInvokerAccessException(Throwable ex) {
		...
		if (ex instanceof ClassNotFoundException || ex instanceof NoClassDefFoundError ||
			...
			return new org.juneframework.remoting.RemoteAccessException(
