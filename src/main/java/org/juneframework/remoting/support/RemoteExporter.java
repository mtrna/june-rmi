...
public abstract class RemoteExporter extends RemotingSupport {
	 ...
	 * @see org.juneframework.remoting.support.RemoteInvocationTraceInterceptor
	 */
	 ...
	 * {@link org.juneframework.remoting.support.RemoteInvocationTraceInterceptor} will be registered (by default).
	 * @return the proxy
	 * @see #setServiceInterface
	...
	protected Object getProxyForService() {
		...
		if (this.registerTraceInterceptor != null ? this.registerTraceInterceptor : this.interceptors == null) {
			proxyFactory.addAdvice(new org.juneframework.remoting.support.RemoteInvocationTraceInterceptor(getExporterName()));
		}
