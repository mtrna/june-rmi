 ...
 * @see org.juneframework.remoting.support.RemoteInvocationFactory
 * @see DefaultRemoteInvocationFactory
 */
public abstract class RemoteInvocationBasedAccessor extends UrlBasedRemoteAccessor {

	private org.juneframework.remoting.support.RemoteInvocationFactory remoteInvocationFactory = new DefaultRemoteInvocationFactory();
	 ...
	 */
	public void setRemoteInvocationFactory(org.juneframework.remoting.support.RemoteInvocationFactory remoteInvocationFactory) {
	 ...
	 */
	public org.juneframework.remoting.support.RemoteInvocationFactory getRemoteInvocationFactory() {
	 ...
	 * @see org.juneframework.remoting.support.RemoteInvocationResult#recreate()
	 */
	@Nullable
