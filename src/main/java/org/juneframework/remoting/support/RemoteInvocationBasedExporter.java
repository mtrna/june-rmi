 ...
 * on deserialization of {@link org.juneframework.remoting.support.RemoteInvocation} objects.
 *
 * <p>Provides a "remoteInvocationExecutor" property, with a
 * {@link org.juneframework.remoting.support.DefaultRemoteInvocationExecutor} as default strategy.
 *
 * @author Juergen Hoeller
 * @since 1.1
 * @see org.juneframework.remoting.support.RemoteInvocationExecutor
 * @see org.juneframework.remoting.support.DefaultRemoteInvocationExecutor
 */
public abstract class RemoteInvocationBasedExporter extends RemoteExporter {

	private org.juneframework.remoting.support.RemoteInvocationExecutor remoteInvocationExecutor = new DefaultRemoteInvocationExecutor();
	 ...
	 */
	public void setRemoteInvocationExecutor(org.juneframework.remoting.support.RemoteInvocationExecutor remoteInvocationExecutor) {
	 ...
	 */
	public org.juneframework.remoting.support.RemoteInvocationExecutor getRemoteInvocationExecutor() {
	 ...
	 */
	protected Object invoke(org.juneframework.remoting.support.RemoteInvocation invocation, Object targetObject)
	 ...
	 * @see #invoke
	 */
	protected org.juneframework.remoting.support.RemoteInvocationResult invokeAndCreateResult(RemoteInvocation invocation, Object targetObject) {
		try {
			Object value = invoke(invocation, targetObject);
			return new org.juneframework.remoting.support.RemoteInvocationResult(value);
		}
		catch (Throwable ex) {
