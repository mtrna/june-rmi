...
/**
 * Server-side implementation of {@link org.juneframework.remoting.rmi.RmiInvocationHandler}. An instance
...
class RmiInvocationWrapper implements RmiInvocationHandler {
	...
	private final org.juneframework.remoting.rmi.RmiBasedExporter rmiExporter;
	 ...
	 */
	public RmiInvocationWrapper(Object wrappedObject, org.juneframework.remoting.rmi.RmiBasedExporter rmiExporter) {
	 ...
	 * @see org.juneframework.remoting.rmi.RmiBasedExporter#getServiceInterface()
	 */
	@Override
	@Nullable
